...
class Message extends Base {
    ...
    constructor(data, client) {
        ...
        /**
         * The guild this message is in (object with undefined "id" key if in DMs)
         * @type {Guild?}
         */
        ...
        if(this.channel.guild) {
            if(data.member) {
                ...
                if (this.channel.guild.members) {
                    ...
                    this.member = new Member(data.member, this.channel.guild, client);
                }
    ...
    update(data, client) {
        if(data.content !== undefined) {
            ...
            this.mentions = data.mentions.map((mention) => {
                ...
                if(mention.member && this.channel.guild?.members) {
