...
class Guild extends Base {
    ...
    constructor(data, client) {
        ...
        if(data.members) {
            for(const member of data.members) {
                ...
                member = this.members.add(member, this);
    ...
    update(data) {
        ...
        if(data.emojis !== undefined) {
             ...
             * @type {Array<Emoji>}
             */
            this.emojis = data.emojis.map((emoji) => new Emoji(emoji, this, this._client));
        }
        ...
        if(data.premium_tier !== undefined) {
            ...
            /**
             * The maximum amount of emojis which can be added to the guild
             * @type {Number}
             */
            this.maxEmojis = data.premium_tier === 3 ? "500" : (data.premium_tier * 100) + 100;
        }
    ...
    /**
     * The member object of the client for this guild
     * @type {Member}
     */
    get me() {
        return this.members && this.members.get(this.#client.user.id);
    }
