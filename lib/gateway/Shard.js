    ...
    wsEvent(packet) {
        switch(packet.t) { /* eslint-disable no-redeclare */ // (╯°□°）╯︵ ┻━┻
            ...
            case "MESSAGE_REACTION_ADD": {
                ...
                if(message) {
                    ...
                    if(packet.d.guild_id) {
                        ...
                        message.guild ??= {id: packet.d.guild_id};
            ...
            case "GUILD_UPDATE": {
                ...
                * @prop {Number} oldGuild.maxEmojis The maximum amount of emojis which can be added to the guild
